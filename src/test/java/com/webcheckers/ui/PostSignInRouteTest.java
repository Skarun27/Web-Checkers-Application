...
public class PostSignInRouteTest {
    ...
    public void successful() {
        ...
        when(request.queryParams(PostSignInRoute.PLAYER_KEY)).thenReturn("Bob");

        //player is added successfully
        when(playerLobby.verifyAndAddNewPlayer(new Player("Bob"))).thenReturn(true);
    ...
    public void unsuccessful() {
        ...
        //when I get the player name from the session, then the player has entered "Bob"
        when(request.queryParams("name")).thenReturn("Bob");

        //player is not added successfully
        when(playerLobby.verifyAndAddNewPlayer(new Player("Bob"))).thenReturn(false);
