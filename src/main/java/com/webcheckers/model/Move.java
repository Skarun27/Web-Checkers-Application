...
public class Move {
    ...
    /**
     * @return a string representing this move object
     */
     ...
     * Tells the user the options of where they can move
     * @return a string representing this move
     */
    public String altString(Piece.pieceColor color) {
        Position s,e;
     ...
     * @return : true if the two are equal based on their name
     */
    @Override
